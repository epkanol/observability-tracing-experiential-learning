...
All LOO-CV values are good, below 0.7.
...
All LOO-CV values are OK, below 0.7.
...
```{r}
plot_M1_posterior_mean(I1, "intent", accessible_mean)
```
...
```{r}
plot_M2_posterior_mean(I2, "intent", accessible_mean)
```
...
```{r}
plot_M2_posterior_mean(I3, "intent", accessible_mean)
```
...
```{r}
plot_M4_posterior_mean(I4, "intent-varying", accessible_mean, limits=c(1,7))
```
