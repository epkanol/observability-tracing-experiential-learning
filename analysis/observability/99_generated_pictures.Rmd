...
```{r}
ai |> group_by(site) |> mutate(profYears=2025-profYear) |> summarize(n(), round(mean(profYears), 1), round(sd(profYears), 1), median(profYears), min(profYears), max(profYears))
jaeger |> group_by(site) |> mutate(profYears=2025-profYear) |> summarize(n(), round(mean(profYears), 1), round(sd(profYears), 1), median(profYears), min(profYears), max(profYears))
vue |> group_by(site) |> mutate(profYears=2025-profYear) |> summarize(n(), round(mean(profYears), 1), round(sd(profYears), 1), median(profYears), min(profYears), max(profYears))

```
Let's use the M4/E4/A4/I4 of all models, and generate pictures and estimates from them.
